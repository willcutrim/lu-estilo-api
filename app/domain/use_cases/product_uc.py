...
class GetFilteredProductsUseCase:
    ...
    def execute(self, skip=0, limit=10, section=None, min_price=None, max_price=None, available=None):
        return self.repo.get_filtered(skip, limit, section, min_price, max_price, available)
